...
function SubNav() {
  return (
    <div className="w-full   flex justify-center items-center bg-primary-green mobile:hidden tablet:hidden">
      <div className="w-9/12 py-2 px-4 bg-light-green flex justify-between items-center rounded-md md:w-11/12">
